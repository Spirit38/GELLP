...
////        //nomCopro = CLI.lireNom();
////        CLI.afficher("Saisir l'adresse :");
////        lieu = new Lieu("","");
////        return new InfosUtilisateur(login, mdp, nomCopro, lieu);
////    }
//
//    private InfosNouvelEvenement dialogueSaisirNouvelEvenement(final List<Evenement> nomsExistants) {
//        String nom;
...
//
//    @Override
//    public void saisirNouvelEvenement(final List<Evenement> nomsExistants) {
...
//     *     l'option vide en cas d'erreur.
//     */
//    private static Optional<String> parseNouveauNom(final String token, final List<Evenement> nomsConnus) {
...
//     *     l'option vide en cas d'erreur.
//     */
//    private static Optional<String> parseNomExistant(final String token, final List<Evenement> nomsConnus) {
//        Optional<String> result;
//        if (nomsConnus.contains(token)) {
//            result = Optional.of(token);
//        } else {
...
//     */
//    private static String lireNom(final List<Evenement> nomsConnus, final boolean nouveau) {
//        if (nouveau) {
//            if (!nomsConnus.isEmpty()) {
//                CLI.afficher("Les noms suivants ne sont plus disponibles :");
//                CLI.afficher("  " + String.join((CharSequence) ", ", (CharSequence) nomsConnus) + ".");
//            }
...
////        return CLI.lireNom(Collections.(), true);
////    }
//
//    /**
//     * Interprète un token comme une chaîne de caractère et vérifie que la
